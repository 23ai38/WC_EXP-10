...
export default function ExpenseTracker() {
  ...
  const incomeCategories = [
    ...
    { value: 'freelance', label: '💼 Freelance', color: 'bg-blue-100 text-blue-700' },
    { value: 'business', label: '🏢 Business', color: 'bg-purple-100 text-purple-700' },
    { value: 'investment', label: '📈 Investment', color: 'bg-indigo-100 text-indigo-700' },
    { value: 'gift', label: '🎁 Gift', color: 'bg-pink-100 text-pink-700' },
    { value: 'other', label: '📦 Other', color: 'bg-gray-100 text-gray-700' },
  ];
  ...
  const getCategoryInfo = (cat) => allCategories.find(c => c.value === cat) || allCategories[allCategories.length - 1];
